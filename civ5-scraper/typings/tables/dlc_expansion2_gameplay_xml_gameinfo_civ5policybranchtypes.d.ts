declare type dlc_expansion2_gameplay_xml_gameinfo_civ5policybranchtypes_PolicyBranchTypes = {
	/**
	 * Primary Key
	 * Auto Increment
	 */
...
declare type dlc_expansion2_gameplay_xml_gameinfo_civ5policybranchtypes_PolicyBranch_Disables = {
	/**
