declare type dlc_expansion2_gameplay_xml_technologies_civ5technologies_Technologies = {
	/**
	 * Primary Key
	 * Auto Increment
	 */
...
declare type dlc_expansion2_gameplay_xml_technologies_civ5technologies_Technology_DomainExtraMoves = {
	/**
...
declare type dlc_expansion2_gameplay_xml_technologies_civ5technologies_Technology_TradeRouteDomainExtraRange = {
	/**
	 * Reference: Technologies(Type)
	 */
	TechType: TEXT,
...
declare type dlc_expansion2_gameplay_xml_technologies_civ5technologies_Technology_Flavors = {
	/**
	 * Reference: Technologies(Type)
	 */
	TechType: TEXT,
...
declare type dlc_expansion2_gameplay_xml_technologies_civ5technologies_Technology_ORPrereqTechs = {
	/**
	 * Reference: Technologies(Type)
	 */
	TechType: TEXT,
...
declare type dlc_expansion2_gameplay_xml_technologies_civ5technologies_Technology_PrereqTechs = {
	/**
	 * Reference: Technologies(Type)
	 */
	TechType: TEXT,
...
declare type dlc_expansion2_gameplay_xml_technologies_civ5technologies_Technology_FreePromotions = {
	/**
	 * Reference: Technologies(Type)
	 */
	TechType: TEXT,
