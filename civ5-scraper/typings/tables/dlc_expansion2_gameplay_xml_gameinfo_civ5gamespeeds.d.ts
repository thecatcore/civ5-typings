declare type dlc_expansion2_gameplay_xml_gameinfo_civ5gamespeeds_GameSpeeds = {
	/**
	 * Primary Key
	 * Auto Increment
	 */
...
declare type dlc_expansion2_gameplay_xml_gameinfo_civ5gamespeeds_GameSpeed_Turns = {
	/**
