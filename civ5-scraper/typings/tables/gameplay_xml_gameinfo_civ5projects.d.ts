declare type gameplay_xml_gameinfo_civ5projects_Projects = {
	/**
	 * Primary Key
	 * Auto Increment
	 */
...
declare type gameplay_xml_gameinfo_civ5projects_Project_Flavors = {
	/**
...
declare type gameplay_xml_gameinfo_civ5projects_Project_Prereqs = {
	/**
	 * Reference: Projects(Type)
	 */
	ProjectType: TEXT,
...
declare type gameplay_xml_gameinfo_civ5projects_Project_VictoryThresholds = {
	/**
	 * Reference: Projects(Type)
	 */
	ProjectType: TEXT,
...
declare type gameplay_xml_gameinfo_civ5projects_Project_ResourceQuantityRequirements = {
	/**
	 * Reference: Projects(Type)
	 */
	ProjectType: TEXT,
