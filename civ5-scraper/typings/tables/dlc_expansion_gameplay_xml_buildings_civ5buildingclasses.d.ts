declare type dlc_expansion_gameplay_xml_buildings_civ5buildingclasses_BuildingClasses = {
	/**
	 * Primary Key
	 * Auto Increment
	 */
...
declare type dlc_expansion_gameplay_xml_buildings_civ5buildingclasses_BuildingClass_VictoryThresholds = {
	/**
