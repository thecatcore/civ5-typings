declare type gameplay_xml_gameinfo_civ5specialists_Specialists = {
	/**
	 * Primary Key
	 * Auto Increment
	 */
...
declare type gameplay_xml_gameinfo_civ5specialists_SpecialistFlavors = {
	/**
...
declare type gameplay_xml_gameinfo_civ5specialists_SpecialistYields = {
	/**
	 * Reference: Specialists(Type)
	 */
	SpecialistType: TEXT,
