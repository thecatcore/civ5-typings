declare type dlc_expansion_gameplay_xml_gameinfo_civ5eras_Eras = {
	/**
	 * Primary Key
	 * Auto Increment
	 */
...
declare type dlc_expansion_gameplay_xml_gameinfo_civ5eras_Era_Soundtracks = {
	/**
	 * Reference: Eras(Type)
	 */
	EraType: TEXT,
...
declare type dlc_expansion_gameplay_xml_gameinfo_civ5eras_Era_CitySoundscapes = {
	/**
	 * Reference: Eras(Type)
	 */
	EraType: TEXT,
...
declare type dlc_expansion_gameplay_xml_gameinfo_civ5eras_Era_NewEraVOs = {
	/**
	 * Reference: Eras(Type)
	 */
	EraType: TEXT,
