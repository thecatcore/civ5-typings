declare type gameplay_xml_civilizations_civ5traits_Traits = {
	/**
	 * Primary Key
	 * Auto Increment
	 */
...
declare type gameplay_xml_civilizations_civ5traits_Trait_ExtraYieldThresholds = {
	/**
...
declare type gameplay_xml_civilizations_civ5traits_Trait_YieldChanges = {
	/**
	 * Reference: Traits(Type)
	 */
	TraitType: TEXT,
...
declare type gameplay_xml_civilizations_civ5traits_Trait_YieldChangesStrategicResources = {
	/**
	 * Reference: Traits(Type)
	 */
	TraitType: TEXT,
...
declare type gameplay_xml_civilizations_civ5traits_Trait_YieldModifiers = {
	/**
	 * Reference: Traits(Type)
	 */
	TraitType: TEXT,
...
declare type gameplay_xml_civilizations_civ5traits_Trait_FreePromotions = {
	/**
	 * Reference: Traits(Type)
	 */
	TraitType: TEXT,
...
declare type gameplay_xml_civilizations_civ5traits_Trait_FreePromotionUnitCombats = {
	/**
	 * Reference: Traits(Type)
	 */
	TraitType: TEXT,
...
declare type gameplay_xml_civilizations_civ5traits_Trait_MovesChangeUnitCombats = {
	/**
	 * Reference: Traits(Type)
	 */
	TraitType: TEXT,
...
declare type gameplay_xml_civilizations_civ5traits_Trait_Terrains = {
	/**
	 * Reference: Traits(Type)
	 */
	TraitType: TEXT,
...
declare type gameplay_xml_civilizations_civ5traits_Trait_ResourceQuantityModifiers = {
	/**
	 * Reference: Traits(Type)
	 */
	TraitType: TEXT,
...
declare type gameplay_xml_civilizations_civ5traits_Trait_ImprovementYieldChanges = {
	/**
	 * Reference: Traits(Type)
	 */
	TraitType: TEXT,
...
declare type gameplay_xml_civilizations_civ5traits_Trait_SpecialistYieldChanges = {
	/**
	 * Reference: Traits(Type)
	 */
	TraitType: TEXT,
