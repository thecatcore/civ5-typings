declare type dlc_expansion2_gameplay_xml_gameinfo_civ5handicapinfos_HandicapInfos = {
	/**
	 * Primary Key
	 * Auto Increment
	 */
...
declare type dlc_expansion2_gameplay_xml_gameinfo_civ5handicapinfos_HandicapInfo_Goodies = {
	/**
...
declare type dlc_expansion2_gameplay_xml_gameinfo_civ5handicapinfos_HandicapInfo_FreeTechs = {
	/**
	 * Reference: HandicapInfos(Type)
	 */
	HandicapType: TEXT,
...
declare type dlc_expansion2_gameplay_xml_gameinfo_civ5handicapinfos_HandicapInfo_AIFreeTechs = {
	/**
	 * Reference: HandicapInfos(Type)
	 */
	HandicapType: TEXT,
